#https://portswigger.net/web-security/learning-paths/file-upload-vulnerabilities/exploiting-unrestricted-file-uploads-to-deploy-a-web-shell/file-upload/lab-file-upload-remote-code-execution-via-web-shell-upload#
import requests
from bs4 import BeautifulSoup
import sys

URL = "https://0afa00960398c67c8094e9a500500099.web-security-academy.net"
login = URL + "/login"
